...
const socialLinks = [
    ...
    {
        name: "LinkedIn",
        href: "https://www.linkedin.com/in/mithilesh-k-a0295632b/",
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        <div className="flex gap-4">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="p-2 rounded-lg bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:bg-violet-100 dark:hover:bg-violet-900/30 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
                ...
                <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800">
                    <p className="text-center text-sm text-zinc-500 dark:text-zinc-500">
                        © {new Date().getFullYear()} Mithilesh. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
