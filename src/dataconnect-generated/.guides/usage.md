...
```ts
import { useCreateUser, useGetProjects, useUpdateSkill, useListPublicUsers } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useListPublicUsers();
...
```js
import { createUser, getProjects, updateSkill, listPublicUsers } from '@dataconnect/generated';
